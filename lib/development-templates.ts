...
export const developmentTemplates: DevelopmentTemplate[] = [
  // 신체 발달 템플릿
  {
    ...
    templateContent:
      '아이의 대근육 운동 능력(앉기, 기어가기, 서기, 걷기 등)에 대한 관찰 내용을 기록합니다.',
    questions: [
  ...
  },
  {
    ...
    developmentArea: 'physical',
    templateContent:
      '아이의 소근육 운동 능력(물건 잡기, 손가락 사용, 그리기 등)에 대한 관찰 내용을 기록합니다.',
    questions: [
      '물건을 손으로 잡을 수 있나요?',
  ...
  // 인지 발달 템플릿
  {
    ...
    templateContent:
      '아이가 문제를 해결하는 방식과 인지적 사고 과정에 대한 관찰 내용을 기록합니다.',
    questions: [
      '간단한 퍼즐을 맞출 수 있나요?',
      '물건이 숨겨진 곳을 찾을 수 있나요?',
  ...
  },
  {
    ...
    developmentArea: 'cognitive',
    templateContent:
      '아이의 기억력과 주의 집중력에 대한 관찰 내용을 기록합니다.',
    questions: [
  ...
  // 언어 발달 템플릿
  {
    ...
    templateContent:
      '아이가 다른 사람의 말을 이해하는 능력에 대한 관찰 내용을 기록합니다.',
    questions: [
      '이름을 부르면 반응하나요?',
  ...
  },
  {
    ...
    developmentArea: 'language',
    templateContent:
      '아이가 말이나 몸짓으로 자신을 표현하는 능력에 대한 관찰 내용을 기록합니다.',
    questions: [
      '옹알이나 소리를 내나요?',
      '첫 단어를 말했나요? 어떤 단어인가요?',
      '두 단어 이상을 조합해서 말하나요?',
  ...
  // 사회성 발달 템플릿
  {
    ...
    templateContent:
      '아이가 자신과 타인의 감정을 인식하고 표현하는 방식에 대한 관찰 내용을 기록합니다.',
    questions: [
  ...
  },
  {
    ...
    developmentArea: 'social',
    templateContent:
      '아이가 다른 사람들과 상호작용하는 방식에 대한 관찰 내용을 기록합니다.',
    questions: [
      '또래와 놀이를 공유하나요?',
  ...
  },
  {
    ...
    developmentArea: 'social',
    templateContent:
      '유아기의 자립심과 독립성 발달에 대한 관찰 내용을 기록합니다.',
    questions: [
      '스스로 먹으려고 시도하나요?',
      '간단한 옷 입기/벗기를 시도하나요?',
      "'내가 할래'라고 주장하나요?",
  ...
  },
  {
    ...
    developmentArea: 'cognitive',
    templateContent:
      '학령전기 아동의 창의성과 상상력 발달에 대한 관찰 내용을 기록합니다.',
    questions: [
      '상상 놀이에 참여하나요?',
      '창의적인 방식으로 문제를 해결하나요?',
      '이야기를 만들어내나요?',
...
export function getTemplatesByAgeAndArea(
  ageGroup: string,
  developmentArea: string,
): DevelopmentTemplate[] {
