  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">다른 부모님들에게 질문하고 육아의 부담을 함께 나누세요.</p>
      </div>

      <Card className="max-w-3xl mx-auto">
        <CardHeader>
          <CardTitle>새 질문</CardTitle>
          <CardDescription>구체적인 질문을 작성하면 더 정확한 답변을 받아 육아 부담을 덜 수 있습니다.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="content" placeholder="질문 내용을 자세히 작성해주세요" rows={10} />
            <p className="text-xs text-muted-foreground">
