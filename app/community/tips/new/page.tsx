  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">다른 부모님들에게 도움이 될 육아 팁을 공유해주세요.</p>
      </div>

      <Card className="max-w-3xl mx-auto">
        <CardHeader>
          <CardTitle>새 육아 팁</CardTitle>
          <CardDescription>실제로 효과를 본 육아 팁이나 노하우를 구체적으로 작성해주세요.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="title">제목</Label>
            <Input id="title" placeholder="팁의 제목을 입력하세요" />
            <p className="text-xs text-muted-foreground">명확하고 구체적인 제목이 더 많은 관심을 받습니다.</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea id="content" placeholder="팁 내용을 자세히 작성해주세요" rows={15} />
            <p className="text-xs text-muted-foreground">
              구체적인 방법, 효과, 주의사항 등을 포함하면 더 유용한 정보가 됩니다. 마크다운 문법을 사용하여 글을
              구조화할 수 있습니다. (## 제목, * 목록 등)
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              관련 키워드를 태그로 추가하면 다른 부모님들이 팁을 찾기 쉬워집니다.
            </p>
          </div>
        </CardContent>
