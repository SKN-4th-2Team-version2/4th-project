  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="my-12">
        <h2 className="text-3xl font-bold mb-6 text-center">마파덜과 함께 가벼워지는 육아</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">다른 부모님들과 경험과 지식을 나누세요</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">검증된 전문가의 육아 정보와 조언을 받으세요</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">아이의 발달 이정표를 추적하고 관리하세요</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground">수면, 식단, 일상 루틴 관리를 도와드립니다</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="my-12 bg-blue-50 rounded-lg p-8 text-center">
        <h2 className="text-2xl font-bold mb-4">마파덜과 함께 육아의 부담을 덜어보세요</h2>
        <p className="mb-6 max-w-2xl mx-auto">
          초보 엄마 아빠들의 경험과 전문가의 조언이 모인 마파덜에서 더 쉽고 즐거운 육아를 경험하세요.
        </p>
