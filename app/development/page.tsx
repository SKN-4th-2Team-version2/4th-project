  ...
  const features = [
    {
      ...
      title: "발달 기록",
      description: "아이의 성장과 발달 과정을 날짜별로 기록하고 특별한 순간을 사진과 함께 저장할 수 있습니다.",
      href: "/development/record",
    },
    {
      icon: <BarChart3 className="h-6 w-6 text-primary" />,
      title: "발달 추적",
      description: "아이의 발달 상황을 영역별로 추적하고 시각적으로 확인할 수 있습니다.",
      href: "/development/tracker",
    },
    {
      icon: <Clock className="h-6 w-6 text-primary" />,
      title: "발달 타임라인",
      description: "시간 순서대로 아이의 발달 과정을 타임라인으로 확인할 수 있습니다.",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">초보 부모님들의 걱정을 덜어주는 아이의 발달 기록 및 추적 서비스입니다.</p>
      </div>
      ...
      <section className="mb-12">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-lg p-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">아이의 소중한 발달 과정을 기록하세요</h2>
            <p className="text-lg mb-6">
              마파덜의 발달 모니터링 서비스로 아이의 성장 과정을 체계적으로 기록하고 추적하여 초보 부모님의 불안과
              부담을 덜어드립니다.
            </p>
            ...
            <Card key={age.id} className="text-center">
              ...
              <div className="p-4 pt-0">
                <Button variant="ghost" className="w-full" size="sm" asChild>
                  <Link href={`/development/record?age=${age.id}`}>기록하기</Link>
                </Button>
              </div>
            </Card>
          ))}
          ...
          {features.map((feature, index) => (
            <Card key={index} className="overflow-hidden">
              ...
              <div className="p-6 pt-0">
                <Button variant="ghost" className="w-full flex items-center justify-center gap-2" asChild>
      ...
      <section className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-8 text-center">
        <h2 className="text-2xl font-bold mb-4">내 아이의 발달 기록 시작하기</h2>
        <p className="mb-6 max-w-2xl mx-auto">
          아이의 발달 상황을 쉽게 기록하고 추적하여 초보 부모님의 불안과 부담을 덜어드립니다. 지금 바로 아이의 소중한
          순간을 기록해보세요.
        </p>
        <Button size="lg" asChild>
          <Link href="/development/record">발달 기록 시작하기</Link>
