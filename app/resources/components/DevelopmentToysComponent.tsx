          ...
          <CardContent>
            ...
            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                ...
                {toyGroup.ageGroup === "4-6개월" && " 감각 발달과 손-눈 협응력을 기를 수 있는 놀이도구가 중요합니다."}
                {toyGroup.ageGroup === "7-9개월" && " 소근육 발달과 인지 능력을 향상시키는 놀이도구가 도움이 됩니다."}
                {toyGroup.ageGroup === "10-12개월" && " 문제해결 능력과 창의성을 기를 수 있는 놀이도구를 추천합니다."}
              </p>
            </div>
          </CardContent>
        </Card>
